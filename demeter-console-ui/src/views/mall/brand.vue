<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="来源ID" prop="sourceBrandId"/>

      <el-table-column align="center" label="品牌来源" prop="sourceType">
        <template slot-scope="scope">
          <el-tag :type="scope.row.sourceType ? '1' : '0' ">{{ scope.row.sourceType === '1' ? 'API接口' : '系统新增' }}</el-tag>
        </template>
      </el-table-column>
