<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button
        v-permission="['GET /console/config/list']"
        class="filter-item"
        type="primary"
        icon="el-icon-search"
      ...
      <el-button
        v-permission="['POST /console/config/create']"
        class="filter-item"
        type="primary"
        icon="el-icon-edit"
    ...
    <el-table
      ...
      <el-table-column align="center" label="操作列表" width="200" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            v-permission="['POST /console/config/update']"
            type="primary"
            size="mini"
            @click="handleUpdate(scope.row)">编辑
          </el-button>
          <el-button
            v-permission="['POST /console/config/delete']"
            type="danger"
            size="mini"
...
<script>
import { createConfig, deleteConfig, listConfig, updateConfig } from '@/api/config'
