<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column align="center" label="公司编码" prop="code"/>
      <el-table-column align="center" label="公司名称" prop="name"/>
      <el-table-column align="center" label="公司简介" prop="content"/>
...
<script>
import { create, remove, list, update, edit } from '@/api/company'
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        code: [{ required: true, message: '运费模板编码称不能为空', trigger: 'blur' }],
  ...
  methods: {
    ...
    updateSite(region) {
      ...
      this.provinceId = region.provinceCode * 1
      this.cityId = region.cityCode * 1
