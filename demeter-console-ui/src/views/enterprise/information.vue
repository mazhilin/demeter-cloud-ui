<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.company" clearable class="filter-item" style="width: 200px;" placeholder="请输入公司名称"/>
      <el-button
    ...
    <el-table
      ...
      <el-table-column align="center" label="序号" prop="id" sortable show-overflow-tooltip="true"/>
      <el-table-column align="center" label="产品名称" prop="name" show-overflow-tooltip="true"/>
      <el-table-column align="center" label="官网地址" prop="portalUrl" show-overflow-tooltip="true"/>
      <el-table-column align="center" label="公司名称" prop="company" show-overflow-tooltip="true"/>
      <el-table-column align="center" label="联系人" prop="contacts" show-overflow-tooltip="true"/>
      <el-table-column align="center" label="联系电话" prop="mobile" show-overflow-tooltip="true"/>
      <el-table-column align="center" label="详细地址" prop="address" show-overflow-tooltip="true"/>
      <el-table-column align="center" label="版权声明" prop="copyright" show-overflow-tooltip="true"/>
