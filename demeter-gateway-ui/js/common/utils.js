var utils = {
    ...
    baseUrl: 'http://127.0.0.1:9003/gateway',
    productCode: function() {
        return window.localStorage.getItem('productCode');
    },
    updateBy: function() {
        ...
        layui.use(['jquery', 'layer'], function() {
            ...
            $.ajax({
                ...
                if(res.code == 200){
                    ...
                    top.location.href = utils.baseUrl + '/manager/view/login.html'
                }else{
...
/*if(top.location.href.indexOf('login') <= -1){
    $.get(utils.baseUrl + "/main/isLogin", {}, function (res) {
        if (res.code == 200) {
            console.log("登陆验证成功")
        } else if (res.code == '500404') {
            top.location.href = utils.baseUrl + '/manager/view/login.html';
